...
///
/// Список пользователей, карточка предмета и дашборд расхода показывают одни и
...
/// запись выглядит по-разному на соседних экранах. Веб-админка использует ровно
/// эти же значения.
...
/// Оттенок аватара закреплён за id: человек не перекрашивается при смене
/// сортировки или фильтра. Это идентичность, а не данные, — поэтому набор
/// отдельный от палитры видов расхода.
const _avatarTints = [
